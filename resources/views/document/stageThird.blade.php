                                            ...
                                            <div class="col-xl-6">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-10"><input class="form-control" type="text"
                                                            ...
                                                            value="{{ old('workPlace') }}" id="workplace" readonly
                                                            required>
                                                        @error('workPlace ')
                                                            <div class="alert alert-danger mt-1 mb-1">{{ $message }}
                                                            </div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-10"><input class="form-control" type="text"
                                                            ...
                                                            value="{{ old('priceAddOn') }}" id="priceaddon" readonly>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-10"><input class="form-control" type="text"
                                                            name="emiPeriod" placeholder="Emi Priod"
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-10"><input class="form-control" type="text"
                                                            ...
                                                            value="{{ old('firstInstallment') }}" id="firstinstallment" readonly required>
                                                ...
                                                <div class="form-group row">
                                                    <label for="example-text-input"
                                                        class="col-sm-4 col-form-label">Zone<span
                                                            style="color: red">*</span></label>
                                                    <div class="col-sm-10"><input class="form-control" type="text"
                                                            name="zone" placeholder="Zone"
                                                            value="{{ old('zone') }}" id="zone" 
                                                            required>
                                                        @error('zone')
                                                            <div class="alert alert-danger mt-1 mb-1">{{ $message }}
                                                            </div>
                                                ...
                                                <div class="form-group row">
                                                    <label for="example-text-input"
                                                        class="col-sm-4 col-form-label">Add-On</label>
                                                    <div class="col-sm-10"><input class="form-control" type="text"
                                                            name="addOn" placeholder="Add-On"
                                                            value="{{ old('addOn') }}" id="addon">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label for="example-text-input"
                                            ...
                                            <div class="col-xl-6">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-10"><input class="form-control" type="date"
                                                            ...
                                                            value="{{ old('dateIssueFile') }}" id="dateissuefile" readonly required>
                                                        @error('dateIssueFile')
                                                            <div class="alert alert-danger mt-1 mb-1">{{ $message }}
                                                            </div>
                                                        @enderror
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-10"><input class="form-control" type="text"
                                                            ...
                                                            value="{{ old('idNumber') }}" id="idnumber" readonly required>
                                                        @error('idNumber')
                                                            <div class="alert alert-danger mt-1 mb-1">{{ $message }}
                                                            </div>
                                                        @enderror
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-10"><input class="form-control" type="text"
                                                            ...
                                                            value="{{ old('occupation') }}" id="occupation" readonly required>
                                                        @error('occupation')
                                                            <div class="alert alert-danger mt-1 mb-1">{{ $message }}
                                                            </div>
                                                        @enderror
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-10"><input class="form-control" type="text"
                                                            ...
                                                            value="{{ old('category') }}" id="category" readonly required>
                                                        @error('category')
                                                            <div class="alert alert-danger mt-1 mb-1">{{ $message }}
                                                            </div>
                                                        @enderror
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-10"><input class="form-control" type="date"
                                                            ...
                                                            value="{{ old('dateIssue') }}" id="dateissue" readonly required>
                                                        @error('dateIssue')
                                                            <div class="alert alert-danger mt-1 mb-1">{{ $message }}
                                                            </div>
                                                        @enderror
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-10"><input class="form-control phone"
                                                            ...
                                                            value="{{ old('buildArea') }}" id="buildarea" readonly required>
                                                        @error('buildArea')
                                                            <div class="alert alert-danger mt-1 mb-1">{{ $message }}
                                                            </div>
                                                        @enderror
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-10"><input class="form-control phone"
                                                            ...
                                                            value="{{ old('landArea') }}" id="landarea" readonly required>
                                                        @error('landArea')
                                                            <div class="alert alert-danger mt-1 mb-1">{{ $message }}
                                                            </div>
                                                        @enderror
        ...
        $("#house").change(function() {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $('#dateissue').val(response.dateIssue);
                    $('#dateissuefile').val(response.dateIssueFile);
                    $('#houseprice').val(response.housePrice);
                    $('#buildarea').val(response.buildArea);
                    $('#landarea').val(response.landArea);
                    $('#firstinstallment').val(response.firstInstallment)
                    $('#zone').val(response.zone)
                     $('#addon').val(response.addOn)
                    $('#emiperiod').val(response.emiPeriod)
                    $('#addonprice').val(response.priceAddOn)
                }
            });
        });
    });
