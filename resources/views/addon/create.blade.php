                                            ...
                                            <div class="col-xl-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-10"><input class="form-control" type="text"
                                                            name="name" placeholder="Add-On Name" oninput="capitalizeFirstLetter(this)" value="{{old('name')}}"
                                                ...
                                                <div class="col-xs-12 col-sm-12 col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea class="form-control" style="height:150px" name="detail" placeholder="Add-On Description" value="{{old('detail')}}" oninput="capitalizeFirstLetter(this)"></textarea>
                                                    </div>
                                                </div> 
                                            ...
                                            <div class="col-xl-6">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-10"><input class="form-control phone" type="text"
                                                            name="price" placeholder="Add-On Price" value="{{old('price')}}"
                                                            id="example-text-input" required>
                                                        @error('price')
                                                            <div class="alert alert-danger mt-1 mb-1">{{ $message }}
                                                            </div>
